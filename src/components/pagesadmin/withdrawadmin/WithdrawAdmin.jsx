            ...
            <div id="content" style={{ minHeight: '73vh' }}>
                <div className="container-fluid">
                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                        {/* Page Heading */}
                        <h1 className="h3 mb-2 text-gray-800">Withdraw Simpanan</h1>
                        {/* breadcrumb */}
                    ...
                    <div className="card shadow mb-4">
                        <div className="col-sm-12">
                            <div id="dataTable_filter" className="dataTables_filter d-flex justify-content-end" style={{ flexDirection: 'row' }}>
                                <label className="" style={{ display: 'flex', alignItems: 'center' }}>Masukan NIK Member<input type="search" className="form-control form-control-sm" style={{ display: 'flex', alignItems: 'center', }} placeholder aria-controls="dataTable" />
                                    <button>
