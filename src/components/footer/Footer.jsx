                ...
                <div className="row">
                    <div className="col-sm-8 d-flex align-items-center justify-content-start">
                        <div className="copyright text-left my-auto">
                            <span>Copyright © 2016 <Link to="https://www.rajaputramedia.com/">Asada KOPERASI.</Link>   All rights reserved</span>
                        </div>
                    </div>
                    <div className="col-sm-3"></div>
                    <div className="col-sm-1 d-flex align-items-center ml-auto">
